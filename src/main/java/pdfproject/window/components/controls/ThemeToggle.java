package pdfproject.window.components.controls;
...
public class ThemeToggle extends JComponent implements MouseListener, KeyListener, FocusListener, ComponentListener {
    ...
    private void setLightDefaults() {
        trackOn = Theme.Slider.TRACK_ON_LIGHT;
        trackOff = Theme.Slider.TRACK_OFF_LIGHT;
        knobFill = Theme.Slider.KNOB_FILL_LIGHT;
        knobBorder = Theme.Slider.KNOB_BORDER_LIGHT;
    }
    ...
    public void updateTheme(Theme theme, boolean dark) {
        ...
        if (dark) {
            trackOn = Theme.Slider.TRACK_ON_DARK;
            trackOff = Theme.Slider.TRACK_OFF_DARK;
            knobFill = Theme.Slider.KNOB_FILL_DARK;
            knobBorder = Theme.Slider.KNOB_BORDER_DARK;
        } else {
            trackOn = Theme.Slider.TRACK_ON_LIGHT;
            trackOff = Theme.Slider.TRACK_OFF_LIGHT;
            knobFill = Theme.Slider.KNOB_FILL_LIGHT;
