package pdfproject.window.experiment.components.body.right.color;
...
public class ColorPanel extends JPanel implements PropertyChangeListener {
    ...
    private void applyTheme(ExperimentTheme t) {
        ...
        Color titleColor = t.headerText != null ? t.headerText : ExperimentTheme.readableForeground(t.bodyBg);
        Color labelColor = t.bodyText != null ? t.usernameAccent : ExperimentTheme.readableForeground(t.bodyBg);
        ...
        for (JComboBox<String> combo : combos) {
            ...
            combo.setForeground(titleColor);
            combo.setRenderer(new DefaultListCellRenderer() {
                ...
                public Component getListCellRendererComponent(JList<?> list, Object value, int index,
                    ...
                    setForeground(isSelected ? ExperimentTheme.readableForeground(t.startButtonColor) : labelColor);
                    return this;
                }
            });
        }
            ...
            if (c instanceof JPanel) {
                for (Component cc : ((Container) c).getComponents()) {
                    if (cc instanceof JButton b) {
                        ...
                        b.setForeground(ExperimentTheme.readableForeground(t.startButtonColor));
                    }
                }
            }
        }
        ...
        Color previewBorder = ExperimentTheme.readableForeground(t.bodyBg).equals(Color.WHITE)
